...
app.include_router(simulation.router, prefix=f"{settings.API_PREFIX}/simulation", tags=["Narrative Holodeck"])
app.include_router(causality.router, prefix=f"{settings.API_PREFIX}/causality", tags=["Butterfly Effect"])
app.include_router(agents.router, prefix=f"{settings.API_PREFIX}/agents", tags=["BDI Agents"])
app.include_router(quantum.router, prefix=f"{settings.API_PREFIX}/quantum", tags=["Quantum Consistency"])
