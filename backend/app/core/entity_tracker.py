...
class EntityTracker:
            ...
            if not state.alive:
                ...
                for i, sentence in enumerate(sentences):
                    if i > death_position and entity.name.lower() in sentence.lower():
                        ...
                        action_words = ["walked", "said", "ran", "took", "grabbed", 
                                        "smiled", "laughed", "fought", "ate", "drank"]
    ...
    async def _check_location_consistency(
        ...
        far_locations = {
            ("paris", "tokyo"), ("new york", "london"), ("australia", "europe"),
            ("earth", "mars"), ("inside", "outside the country")
        }
