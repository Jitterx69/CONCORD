...
class NarrativeFixer:
    ...
    async def generate_fixes(
        self, issue: ConsistencyIssue, facts: List[Fact], narrative_text: str
    ) -> List[FixSuggestion]:
        """
    ...
    async def _generate_factual_fixes(
        self, issue: ConsistencyIssue, facts: List[Fact], text: str
    ) -> List[FixSuggestion]:
    ...
    async def _generate_temporal_fixes(
        self, issue: ConsistencyIssue, text: str
    ) -> List[FixSuggestion]:
    ...
    async def get_auto_fixes(
        self, issues: List[ConsistencyIssue], facts: List[Fact], narrative_text: str
    ) -> List[FixSuggestion]:
        """
