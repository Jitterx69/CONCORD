...
class SimulationEngine:
    ...
    async def process_action(self, character: str, action: str) -> Dict[str, Any]:
        ...
        try:
            ...
            lib_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../cpp_sim", lib_name))
            
            self.phys_lib = ctypes.CDLL(lib_path)
            self.phys_lib.api_estimate_travel_time.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double,
