...
async def main():
    ...
    fact_b = Fact(subject="Victim", predicate="died_of", object="stab wound", 
                 dependencies=[fact_a.id], validity_status="valid")
    await kg.add_fact(fact_b)
    
    fact_c = Fact(subject="Police", predicate="found", object="bloody blade", 
                 dependencies=[fact_b.id], validity_status="valid")
