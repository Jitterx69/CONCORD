...
def verify_kafka():
    ...
    if not bus.producer:
        print("❌ Failed to initialize Producer. ensure Docker is running and ports are mapped.")
        return

    print("📤 Publishing test event...")
    fact_id = str(uuid.uuid4())
    bus.publish("narrative.facts.created", {
        "fact_id": fact_id,
        "subject": "TestSubject",
    ...
    print(f"✅ Event {fact_id} published. Check 'docker logs concord-rust-core' to see if it was consumed.")
